...
template <typename T>
bool Hessenberg<T>::isUnreduced(Real tolerance) const
{
    throw LinalgError("not implemented: linalg::Hessenberg<T>::isUnreduced");
}

template <typename T>
typename Hessenberg<T>::Index Hessenberg<T>::firstNegligibleSubdiagonal(Real tolerance) const
{
    throw LinalgError("not implemented: linalg::Hessenberg<T>::firstNegligibleSubdiagonal");
}
...
template <typename T>
void Tridiagonal<T>::compute(const Matrix<T>& a)
{
    throw LinalgError("not implemented: linalg::Tridiagonal<T>::compute");
}

template <typename T>
bool Tridiagonal<T>::isComputed() const
{
...
template <typename T>
Matrix<T> Tridiagonal<T>::matrixT() const
{
    throw LinalgError("not implemented: linalg::Tridiagonal<T>::matrixT");
}

template <typename T>
Matrix<T> Tridiagonal<T>::matrixQ() const
{
    throw LinalgError("not implemented: linalg::Tridiagonal<T>::matrixQ");
}

template <typename T>
typename Tridiagonal<T>::Index Tridiagonal<T>::eigenvalueCountBelow(Real shift) const
{
    throw LinalgError("not implemented: linalg::Tridiagonal<T>::eigenvalueCountBelow");
}
...
template <typename T>
void Bidiagonal<T>::compute(const Matrix<T>& a)
{
    throw LinalgError("not implemented: linalg::Bidiagonal<T>::compute");
}

template <typename T>
bool Bidiagonal<T>::isComputed() const
{
...
template <typename T>
Matrix<T> Bidiagonal<T>::matrixB() const
{
    throw LinalgError("not implemented: linalg::Bidiagonal<T>::matrixB");
}

template <typename T>
Matrix<T> Bidiagonal<T>::matrixU() const
{
    throw LinalgError("not implemented: linalg::Bidiagonal<T>::matrixU");
}

template <typename T>
Matrix<T> Bidiagonal<T>::matrixV() const
{
    throw LinalgError("not implemented: linalg::Bidiagonal<T>::matrixV");
}

template <typename T>
bool Bidiagonal<T>::usedRPreprocessing() const
{
    throw LinalgError("not implemented: linalg::Bidiagonal<T>::usedRPreprocessing");
}
