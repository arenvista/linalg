...
template <typename T> LU<T>::LU() {
    throw LinalgError("not implemented: linalg::LU<T>::LU");
}

template <typename T> LU<T>::LU(const Matrix<T> &a) {
    throw LinalgError("not implemented: linalg::LU<T>::LU");
}
...
template <typename T> bool LU<T>::isComputed() const {
...
template <typename T> void LU<T>::blockedFactorize(Index blockSize) {
...
template <typename T> FullPivLU<T>::FullPivLU() {
    throw LinalgError("not implemented: linalg::FullPivLU<T>::FullPivLU");
}

template <typename T> FullPivLU<T>::FullPivLU(const Matrix<T> &a) {
    throw LinalgError("not implemented: linalg::FullPivLU<T>::FullPivLU");
}
...
template <typename T> Matrix<T> FullPivLU<T>::columnPermutation() const {
    throw LinalgError(
        "not implemented: linalg::FullPivLU<T>::columnPermutation"
    );
}
