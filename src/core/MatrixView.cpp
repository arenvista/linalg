...
template <typename T>
MatrixView<T>::MatrixView(T* data, Index rows, Index cols, Index rowStride, Index colStride)
{
    throw LinalgError("not implemented: linalg::MatrixView<T>::MatrixView");
}
...
template <typename T>
T& MatrixView<T>::operator()(Index i, Index j)
{
    throw LinalgError("not implemented: linalg::MatrixView<T>::operator()");
}
...
template <typename T>
T& MatrixView<T>::at(Index i, Index j)
{
    throw LinalgError("not implemented: linalg::MatrixView<T>::at");
}

template <typename T>
const T& MatrixView<T>::at(Index i, Index j) const
{
    throw LinalgError("not implemented: linalg::MatrixView<T>::at");
}
...
template <typename T>
bool MatrixView<T>::isContiguous() const
{
    throw LinalgError("not implemented: linalg::MatrixView<T>::isContiguous");
}

template <typename T>
bool MatrixView<T>::isEmpty() const
{
...
{
    throw LinalgError("not implemented: linalg::ConstMatrixView<T>::ConstMatrixView");
}

template <typename T>
ConstMatrixView<T>::ConstMatrixView(const T* data, Index rows, Index cols, Index rowStride, Index colStride)
{
    throw LinalgError("not implemented: linalg::ConstMatrixView<T>::ConstMatrixView");
}
...
{
    throw LinalgError("not implemented: linalg::ConstMatrixView<T>::operator()");
}

template <typename T>
const T& ConstMatrixView<T>::at(Index i, Index j) const
{
...
template <typename T>
bool ConstMatrixView<T>::isContiguous() const
{
    throw LinalgError("not implemented: linalg::ConstMatrixView<T>::isContiguous");
}

template <typename T>
bool ConstMatrixView<T>::isEmpty() const
{
    throw LinalgError("not implemented: linalg::ConstMatrixView<T>::isEmpty");
}

template <typename T>
const T* ConstMatrixView<T>::data() const
{
    throw LinalgError("not implemented: linalg::ConstMatrixView<T>::data");
}

template <typename T>
ConstMatrixView<T> ConstMatrixView<T>::block(Index i, Index j, Index numRows, Index numCols) const
{
...
template <typename T>
ConstMatrixView<T> ConstMatrixView<T>::diagonal() const
{
...
{
    throw LinalgError("not implemented: linalg::ConstMatrixView<T>::transposed");
}

template <typename T>
Matrix<T> ConstMatrixView<T>::toMatrix() const
{
