...
template <typename T>
Matrix<T>::Matrix(Index rows, Index cols)
{
    throw LinalgError("not implemented: linalg::Matrix<T>::Matrix");
}

template <typename T>
Matrix<T>::Matrix(Index rows, Index cols, const T& fill)
{
    throw LinalgError("not implemented: linalg::Matrix<T>::Matrix");
}
...
template <typename T>
Matrix<T> Matrix<T>::Zeros(Index rows, Index cols)
{
    throw LinalgError("not implemented: linalg::Matrix<T>::Zeros");
}

template <typename T>
Matrix<T> Matrix<T>::Ones(Index rows, Index cols)
{
...
template <typename T>
Matrix<T> Matrix<T>::Identity(Index size)
{
...
template <typename T>
Matrix<T> Matrix<T>::Hilbert(Index size)
{
...
template <typename T>
T& Matrix<T>::at(Index i, Index j)
{
    throw LinalgError("not implemented: linalg::Matrix<T>::at");
}

template <typename T>
const T& Matrix<T>::at(Index i, Index j) const
{
    throw LinalgError("not implemented: linalg::Matrix<T>::at");
}
...
template <typename T>
typename Matrix<T>::Index Matrix<T>::rows() const
{
    throw LinalgError("not implemented: linalg::Matrix<T>::rows");
}

template <typename T>
typename Matrix<T>::Index Matrix<T>::cols() const
{
    throw LinalgError("not implemented: linalg::Matrix<T>::cols");
}

template <typename T>
typename Matrix<T>::Index Matrix<T>::size() const
{
...
template <typename T>
ConstMatrixView<T> Matrix<T>::block(Index i, Index j, Index numRows, Index numCols) const
{
    throw LinalgError("not implemented: linalg::Matrix<T>::block");
}

template <typename T>
MatrixView<T> Matrix<T>::rowView(Index i)
{
    throw LinalgError("not implemented: linalg::Matrix<T>::rowView");
}

template <typename T>
ConstMatrixView<T> Matrix<T>::rowView(Index i) const
{
    throw LinalgError("not implemented: linalg::Matrix<T>::rowView");
}

template <typename T>
MatrixView<T> Matrix<T>::colView(Index j)
{
    throw LinalgError("not implemented: linalg::Matrix<T>::colView");
}

template <typename T>
ConstMatrixView<T> Matrix<T>::colView(Index j) const
{
    throw LinalgError("not implemented: linalg::Matrix<T>::colView");
}
...
template <typename T>
void Matrix<T>::setRow(Index i, const Vector<T>& values)
{
    throw LinalgError("not implemented: linalg::Matrix<T>::setRow");
}

template <typename T>
void Matrix<T>::setCol(Index j, const Vector<T>& values)
{
...
template <typename T>
Matrix<T> Matrix<T>::scaledBy(const T& scalar) const
{
...
{
    throw LinalgError("not implemented: linalg::Matrix<T>::elementwiseQuotient");
}
...
template <typename T>
Matrix<T> Matrix<T>::power(Index exponent) const
{
...
template <typename T>
Matrix<T> Matrix<T>::withoutRow(Index i) const
{
    throw LinalgError("not implemented: linalg::Matrix<T>::withoutRow");
}

template <typename T>
Matrix<T> Matrix<T>::withoutCol(Index j) const
{
...
template <typename T>
void Matrix<T>::resize(Index rows, Index cols)
{
...
template <typename T>
void Matrix<T>::swapRows(Index a, Index b)
{
    throw LinalgError("not implemented: linalg::Matrix<T>::swapRows");
}

template <typename T>
void Matrix<T>::swapCols(Index a, Index b)
{
...
template <typename T>
typename Matrix<T>::Real Matrix<T>::oneNorm() const
{
    throw LinalgError("not implemented: linalg::Matrix<T>::oneNorm");
}

template <typename T>
typename Matrix<T>::Real Matrix<T>::infinityNorm() const
{
...
template <typename T>
typename Matrix<T>::Real Matrix<T>::maxNorm() const
{
    throw LinalgError("not implemented: linalg::Matrix<T>::maxNorm");
}

template <typename T>
typename Matrix<T>::Real Matrix<T>::spectralNorm() const
{
...
template <typename T>
bool Matrix<T>::isSymmetric(Real tolerance) const
{
    throw LinalgError("not implemented: linalg::Matrix<T>::isSymmetric");
}

template <typename T>
bool Matrix<T>::isHermitian(Real tolerance) const
{
    throw LinalgError("not implemented: linalg::Matrix<T>::isHermitian");
}

template <typename T>
bool Matrix<T>::isDiagonal(Real tolerance) const
{
...
template <typename T>
bool Matrix<T>::isOrthogonal(Real tolerance) const
{
...
template <typename T>
Matrix<T> Matrix<T>::pseudoInverse(Real tolerance) const
{
...
template <typename T>
void Matrix<T>::checkBounds(Index i, Index j) const
{
